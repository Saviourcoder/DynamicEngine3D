...
inline Vector3 Add(const Vector3& a, const Vector3& b) { return { a.x + b.x, a.y + b.y, a.z + b.z, 0.0f }; }
inline Vector3 Sub(const Vector3& a, const Vector3& b) { return { a.x - b.x, a.y - b.y, a.z - b.z, 0.0f }; }
inline Vector3 Scale(const Vector3& a, float s) { return { a.x * s, a.y * s, a.z * s, 0.0f }; }
inline Vector3 Neg(const Vector3& a) { return { -a.x, -a.y, -a.z, 0.0f }; }
