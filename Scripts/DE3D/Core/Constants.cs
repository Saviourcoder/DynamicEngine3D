...
namespace DynamicEngine
{
    public static class PhysicsConstants
    {
        ...
        public const float MIN_COLLISION_DISTANCE = 0.0001f;
        public const float DEFAULT_COLLISION_EPSILON = 1e-6f;
        ...
        public const float CROSS_BODY_CONSTRAINT_DAMPING = 0f;
