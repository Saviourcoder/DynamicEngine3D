...
namespace DynamicEngine
{
    public class NodeManager
    {
        ...
        public void AddNode(Transform transform, Vector3 localPosition)
        {
            ...
            nodes.Add(transform);
            initialNodePositions.Add(localPosition); // Store the provided local position
            previousPositions.Add(localPosition); // Use the provided local position for consistency
            predictedPositions.Add(localPosition); // Use the provided local position for consistency
            isPinned.Add(false);
