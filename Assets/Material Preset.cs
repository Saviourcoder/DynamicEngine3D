...
namespace DynamicEngine
{
    ...
    public class MaterialProps
    {
        ...
        // Internal pressure properties
        [SerializeField] public float internalPressure;
        [SerializeField] public float pressureForceMultiplier;
        ...
        public MaterialProps(
            ...
            float internalPressure = 0f,
            float pressureForceMultiplier = 1f)
        {
            this.name = name;
            ...
            this.pressureForceMultiplier = pressureForceMultiplier;
        }
