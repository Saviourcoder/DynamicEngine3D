...
namespace DynamicEngine
{
    ...
    public class Constraint : MonoBehaviour
    {
        ...
        [SerializeField] private Snap[] snaps = new Snap[0];
        
        [Header("Motor Configuration")]
        [SerializeField] private bool enableMotor = false;
        [SerializeField] private string axisNodeSet = "";
        [SerializeField] private float targetRate = 0f;
        [SerializeField] private float maxTorque = 0f;
        ...
        public string motorAxis => axisNodeSet;
        ...
        private void CreateConstraint()
        {
            ...
            Debug.Log($"SoftBodyConstraint: Created constraint on {gameObject.name} with {snaps.Length} snaps");
        }
        ...
        {
            // Get the NodeLinkEditor to add custom links
            var nodeLinkEditor = attachedBody?.GetComponent<NodeLinkEditor>();
            if (nodeLinkEditor == null)
            {
                Debug.LogWarning($"No NodeLinkEditor found on {attachedBody.name}. Cannot create custom link.");
                return;
            }
            ...
            // Add the link to the NodeLinkEditor
        ...
        void OnDrawGizmos()
        {
            ...
            if (!showSnaps || !Application.isPlaying) return;
