    ...
    public class TrussJson
    {
        ...
        public static TrussJson FromTxTruss(TxTruss txTruss)
        {
            ...
            var json = new TrussJson
            {
                ...
                nodeMasses = txTruss.nodeMass != null ? (float[])txTruss.nodeMass.Clone() : new float[txTruss.nodeCount],
                ...
                {
                    name = txTruss.name,
                    nodeMass = txTruss.nodeMass != null && txTruss.nodeMass.Length > 0 ? txTruss.nodeMass[0] : 0.5f,
                    compliance = 0.01f,
                    damping = 0.3f
                },
                nodeMass = txTruss.nodeMass != null && txTruss.nodeMass.Length > 0 ? txTruss.nodeMass[0] : 0.5f,
        ...
        public Truss ToTruss()
        {
            ...
            truss.SetPhysicsProperties(nodeMass, maxStretchFactor, minStretchFactor);
                ...
                if (asset is Truss truss)
                {
                    ...
                    if (!string.IsNullOrEmpty(path))
                    {
                        TrussJson jsonData = new TrussJson
                        {
                            ...
                            nodeMasses = new float[truss.NodePositions.Length].Select((_, i) => truss.NodeMass).ToArray(),
