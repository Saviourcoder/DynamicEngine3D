...
namespace DynamicEngine
{
    ...
    public class TrussJson
    {
        ...
        public Truss ToTruss()
        {
            ...
            // Use SetMaxStretchFactor / SetMinStretchFactor rather than SetPhysicsProperties,
            // which clears and uniformly overwrites nodeMasses, losing per-node values.
            truss.SetMaxStretchFactor(maxStretchFactor);
            truss.SetMinStretchFactor(minStretchFactor);
            // Restore global compliance and damping that were serialised into beamProperties.
            if (beamProperties != null)
            {
                truss.compliance = beamProperties.compliance;
                truss.DefaultBeamDamping = beamProperties.damping;
            }
