...
namespace DynamicEngine
{
    ...
    public class CameraVisualizerControllerEditor : UnityEditor.Editor
    {
        ...
        private SerializedProperty nodeGrabStiffness;
        ...
        void OnEnable()
        {
            ...
            nodeGrabStiffness = serializedObject.FindProperty("nodeGrabStiffness");
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (showGrabbingSettings)
            {
                ...
                EditorGUILayout.PropertyField(nodeGrabStiffness, new GUIContent("Grab Stiffness"));
        ...
        private int GetTotalNodeCount(CameraVisualizerController controller)
        {
            ...
            {
                if (sb != null && sb.solver?.nodeManager != null)
                {
                    total += sb.solver.nodeManager.NodeCount;
                }
            }
            return total;
        }
