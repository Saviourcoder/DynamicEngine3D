...
{
    internal static class BoundingBoxConstants
    {
        public static readonly float4[] HomogenousCorners = {
    ...
    public struct BoundingBox : IEquatable<BoundingBox>
    {
        ...
        public static BoundingBox FromFrustum(ref float4x4 axisTransform, ref float4x4 modelViewProj)
        {
            ...
            for (int i = 0; i < BoundingBoxConstants.HomogenousCorners.Length; ++i)
            {
                float4 corner = math.mul(BoundingBoxConstants.HomogenousCorners[i], inverse);
