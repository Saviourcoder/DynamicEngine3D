...
namespace DynamicEngine
{
    public class SceneSettings : MonoBehaviour
    {
        ...
        [SerializeField]
        private float m_globalDamping = 0.0f;
        ...
        {
            get { return m_globalDamping; }
            set { m_globalDamping = value; }
        }

        public float SimHz
        {
            get { return m_substepSize > 0f ? 1f / m_substepSize : 0f; }
        }
        ...
        void OnGUI()
        {
            ...
            GUI.Label(new Rect(10, 120, 200, 40), "Sim Hz: " + SimHz.ToString("F1"), style);
        }
