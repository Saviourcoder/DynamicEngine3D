...
namespace DynamicEngine
{
    ...
    public class DesignerEditor : Editor
    {
        ...
        private void DelayedInitializeSoftBody()
        {
            ...
            // Automatically load the TrussAsset data into the Designer
        ...
        private void DrawInfoTab()
        {
            ...
            GUI.enabled = false;
            EditorGUILayout.ObjectField("Truss", editor.softBody?.truss, typeof(TrussAsset), true);
        ...
        private void DrawDebuggingTab()
        {
            ...
            EditorGUILayout.BeginHorizontal();
            if (GUILayout.Button("Cleanup Duplicate Nodes"))
            {
                editor.CleanupDuplicateNodes();
                EditorUtility.SetDirty(editor);
            }
            if (GUILayout.Button("Validate & Fix Beams"))
            {
                editor.ValidateAndFixBeams();
                EditorUtility.SetDirty(editor);
            }
            EditorGUILayout.EndHorizontal();
