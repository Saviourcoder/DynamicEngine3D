...
namespace DynamicEngine
{
    public class SoftBody : MonoBehaviour
    {
        ...
        [SerializeField, Range(0.1f, 5000f)] private float scaledMass = 1f;
        ...
        // Pressure accessor converted to Pascals (1 PSI = 6894.76 Pascals)
        ...
        public float ScaledMass
        {
            ...
            set
            {
                ...
                if (solver != null && solver.nodeManager.Nodes != null)
                {
                    ...
                    if (nodeCount > 0)
                    {
                        float baseMassPerNode = scaledMass / nodeCount;
        ...
        private void Awake()
        {
            ...
            Debug.Log("SoftBody: Initialized with " + (useAdvancedSkinning ? "Advanced" : "Basic") + " skinning");
        ...
        private bool InitializeCore()
        {
            ...
            // Apply Matter asset if assigned
            if (matter != null)
            {
