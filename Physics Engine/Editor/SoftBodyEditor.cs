    ...
    public class SoftBodyEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (softBody.GetMatterAsset() != null)
            {
                ...
                Matter matter = softBody.GetMatterAsset();
                EditorGUILayout.LabelField("Material Properties", EditorStyles.boldLabel);
                EditorGUILayout.LabelField($"Dynamic Friction: {matter.DynamicFriction:F2}");
                EditorGUILayout.LabelField($"Static Friction: {matter.StaticFriction:F2}");
                EditorGUILayout.LabelField($"Restitution: {matter.Restitution:F2}");
                EditorGUI.indentLevel--;
            ...
            if (showPressureSettings)
            {
                ...
                if (enableInternalPressureProp != null && enableInternalPressureProp.boolValue)
                {
                    ...
                    if (showForcesProp != null)
                        EditorGUILayout.PropertyField(showForcesProp, new GUIContent("Show Force Vectors"));
                }
                EditorGUI.indentLevel--;
            }
            EditorGUILayout.Space();
